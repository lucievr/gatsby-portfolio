...
},
{
  ...
  video: false,
  delay: 100,
  subtitle: 'Deformative video essay project',
  tech: 'Python, Videogrep, FFmpeg, and FFprobe for automated video processing.',
  demoUrl: 'https://historyonfilm.leeds.ac.uk/men-shouting-work-in-progress/',
  codeUrl: ''
}
];
