...
validationSchema={SignupSchema}
    ...
    <Form className="form-style" onSubmit={handleSubmit}>
      <Form.Row>
        <Form.Group as={Col} md="6" controlId="formGridName">
          ...
          <Form.Control className="form-control" type="text" placeholder="Enter your name" name="name"
    ...
    <Form.Control className="form-control" type="text" as="textarea" rows="5" placeholder="Enter your message here..."
    name="message"
    onChange={handleChange}
    onBlur={handleBlur}
